...
const BreathingGame = () => {
  ...
  return (
    <WavyBackground backgroundFill={isDarkMode ? 'black' : 'white'}>
      <div className={`flex flex-col justify-center items-center min-h-screen ${isDarkMode ? 'text-white' : 'text-black'} transition-colors duration-300`}>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          <button
            ...
            className={`control-btn p-2 rounded-full ${isDarkMode ? 'bg-yellow-400 hover:bg-yellow-500' : 'bg-gray-700 hover:bg-gray-800'} text-gray-900 transition-colors duration-300 relative`}
          >
            {isDarkMode ? <Sun size={24} /> : <Moon size={24} />}
            <span className="absolute bg-gray-900 text-white text-sm px-2 py-1 rounded-lg transition-opacity duration-300 whitespace-nowrap">
              {isDarkMode ? 'Light mode' : 'Dark mode'}
            </span>
          </button>
          <button
            onClick={toggleMusic}
            className={`control-btn p-2 rounded-full ${isDarkMode ? 'bg-green-600 hover:bg-green-700' : 'bg-green-500 hover:bg-green-600'} text-white transition-colors duration-300 relative`}
          >
          ...
          <button
            onClick={toggleTTS}
            className={`control-btn p-2 rounded-full ${isDarkMode ? 'bg-purple-600 hover:bg-purple-700' : 'bg-purple-500 hover:bg-purple-600'} text-white transition-colors duration-300 relative`}
          >
